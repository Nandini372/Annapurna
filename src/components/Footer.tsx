      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-600">info@vjit.ac.in</li>
              <li className="text-gray-600">+91 7373637459</li>
              <li className="text-gray-600">Aziz nagar,moinabad,Hyderabad-500075,Telangana,India</li>
            </ul>
          </div>
        </div>
